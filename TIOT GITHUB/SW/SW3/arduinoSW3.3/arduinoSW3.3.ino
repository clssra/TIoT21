...
const int capacity = JSON_OBJECT_SIZE(3) + JSON_ARRAY_SIZE(4) + JSON_OBJECT_SIZE(4) + 40;
...
String senMlEncode2(String res[], float v, String unit){
  doc_snd.clear();
...
void loop() {
  ...
  */
  ...
  String msg2[] = {"temperature", "noise", "presence"};

  String message = senMlEncode2(msg2, 2456, "ciaoo");
